...
(i32.sub 
(i32.const 0)
(local.get 4))(i32.const -39)))
                                    (i32.const 7))))))(i32.const -47))))
                          (i32.lt_u
                            (local.get 0)
                            (i32.sub ;;Replacement 
(i32.const 0)
                            ...
                            (i32.xor(i32.or
                              ...
                              (i32.or
                                ...
                                (i32.shr_u
                                  (i32.load offset=48
                                    (local.get 3))
                                  (i32.const 11))))))))(i32.xor(i32.and(i32.load offset=48
                              (local.get 3))
                            (i32.load offset=52
                              (local.get 3)))
...
(i32.xor(i32.or
                      ...
                      (i32.xor(i32.or
                        ...
                        (i32.load offset=40
                          (local.get 3)))
                      (i32.xor(i32.and(i32.load offset=32
                            (local.get 3))
                          (i32.load offset=36
                            (local.get 3)))
                        (i32.and(i32.load offset=32
