...
(i32.const 0)
(i32.add(local.get 2)
                (i32.const 144)))(i32.shl(i32.load offset=12
                  (local.get 2))
                (i32.const 3))))
            (local.get 3))
          (i32.store offset=12
...
(local.tee 0
                      (i32.add(local.get 2)
                        (i32.const 16))))(i32.shl(i32.load offset=12
                        (local.get 2))
                      (i32.const 3))))))
              (i64.load
                (i32.add(local.get 0)
...
(i32.const 1023))(i32.const 1)
                      ...
                      (i32.store offset=16652
                        (local.get 0)
                        (i32.add(i32.add(i32.sub ;;Replacement 
(i32.const 0)
(i32.sub 
(i32.sub 
(i32.const 0)
...
(i32.add(i32.load offset=16704
                                (local.get 0))
                              (i32.const 16384)))(i32.mul(i32.load offset=16696
                                (local.get 0))
...
(i32.const 0)
(i32.load offset=16652
                                          (local.get 0)))(i32.shl(i32.add(i32.load offset=16672
                                              (local.get 0))
                                            (i32.const 1))
                                          (i32.const 2))))))(i32.or 
(i32.sub 
...
(i32.const 0)
(i32.load offset=16688
                        (local.get 0)))(i32.add(local.get 0)
                        (i32.const 16384)))))
                  (i32.add(local.tee 1
                      (i32.load8_u
                        (local.get 1)))
...
(i32.sub 
(i32.const 0)
(i32.add(i32.add(i32.load offset=16704
                          (local.get 0))
                        (i32.mul(i32.load offset=16696
                            (local.get 0))
                          (i32.const 25088)))
...
(i32.sub 
(i32.const 0)
(i32.add(i32.add(i32.add(i32.mul(i32.load offset=16
                          (local.get 3))
                        (i32.const 25088))
                      (select
                        (i32.const 102778984)
...
(i32.load offset=36
                ...
                (i32.const 2))))
            (i32.load
              (i32.add(i32.add(i32.add(i32.sub ;;Replacement 
(i32.const 0)
(i32.sub 
(i32.sub 
(i32.const 0)
...
(i32.load offset=4
          (i32.load offset=28
            (local.get 2))))(i32.add(i32.load offset=28
            (local.get 2))
          (i32.const 8))))
      (i32.sub
        (i32.load offset=16
...
(i32.add(i32.load offset=28
                      (local.get 2))
                    (i32.const 136)))(i32.shl(i32.load offset=8
                      (local.get 2))
                    (i32.const 2)))))
              (i32.const 24)))
          (i32.store offset=8
...
(local.get 0))(i32.shl(i32.sub
                                (i32.load offset=12
                                  (local.get 3))
                                (i32.const 7))
                              (i32.const 2))))))(i32.xor(i32.and ;; REPLACEMENT 
(i32.or 
(i32.or
                              (i32.shl(i32.load
                                  (i32.sub ;;Replacement 
...
(i32.const 0)
(i32.load offset=12
                (local.get 1)))(i32.add(i32.shl(i32.load
                    (local.get 1))
                  (i32.const 1))
                (i32.const 1))))
            (local.get 0))
